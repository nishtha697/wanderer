...
const Profile = () => {
    ...
    const userId = isFriendProfile === true ? friendUserId : JSON.parse(localStorage.getItem("user"))._id;
    useEffect(() => {
    ...
    const handleSaveProfile = (name, bio) => {
        debugger;
            ...
            <>
                <div className="profile-name">
                    <h4 className="name">
                        ...
                        {provider !== null && provider.verified === true && user.role === "provider" && (
                            <i className="fas fa-check-circle"/>
                        )}
                    </h4>
                    <div>{user.description}</div>
                    {(!friendUserId || user.role === "provider") && <div>{user.email}</div>}
                    <br/>
                ...
                {!isFriendProfile && (
                    <>
                        ...
                        {user.firstName !== undefined && <EditProfile user={user}
                ...
                <div className="row">
                    ...
                    <div className="col-8">
                        <div className="profile-header">
                            <img
                                className={`rounded image ${!isFriendProfile
                                                            && "editImage"}`}
                                alt="banner"
                        ...
                        <div className="profile">
                            ...
                            <ul className="nav nav-tabs mt-2">
                                ...
                                {!isFriendProfile && (user.role === "user" || (provider
                                                                               && provider.verified
                                                                               === true)) && (
                                     <li className="nav-item">
                                         <div
                                ...
                                { JSON.parse(localStorage.getItem("user")) && <li className="nav-item">
                                    <Link
                                        className={`nav-link ${
...
const EditProfile = ({ user, handleSaveProfile}) => {
            ...
            <div className="row mb-2 wd-edit-header pb-2">
                ...
                <div className="col-2 mt-2">
                    <button
                        ...
                        onClick={() => handleSaveProfile(name, bio)}
                    >
                        Save
                    </button>
                </div>
