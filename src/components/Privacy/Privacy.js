...
const Privacy = () => {
    ...
    return (
        <div className="container mt-5">
            ...
            <h1 className="wd-privacy"> Terms of Service</h1>
            <hr/>
            <h4> Summary</h4>
            <p>
                Wanderer is public and posts are immediately viewable and searchable by anyone
                around
                the world. At the moment, no messages are private and all messages may be viewed
                publicly
                by persons who are or are not registered.
            </p>
            <p>
                When you use Wanderer, we receive only the personal information you chose to share
                with us,
                such as e-mail, address, and locations visited, which are displayed on a map.
            </p>
            <p>
                We will not use your information for marketing purposes but we may use it for
                security purposes.
                If you register as a Provider, we will require your credit card information and you
                may choose
                to share and advertise your place of business to the public. We will collect the
                information you provide
                regarding your place of business.
            </p>
            <p>
                In further regard to Providers, we may collect further information to protect our
                users
                from advertisement of illegal or illicit business and take action to prevent
                dissemination
                of content we feel does not relate to the spirit of travel.
            </p>
            <p>
                Maps are generated using API MapBox. We will not share your personal information,
                including addresses, with MapBox.
            </p>
            <h4>Personal Data</h4>
            <p>
            ...
            <p>
                ...
                Necessary / Essential Cookies Type: Session Cookies Administered by: Purpose: These
                Cookies are essential to provide You with services available through the Website and
                ...
                with those services.
                Cookies Policy / Notice Acceptance Cookies Type: Persistent Cookies Administered by:
            ...
            <ul>
                ...
                <li> To contact users registered as Providers concerning pending registration status
            ...
            <p>
                The Company will store and retain Your Personal Data only for as long as is
                ...
                We do not use data for analysis purposes.

            </p>

            <h4> Disclosure of Your Personal Data </h4>
            <ul>
                <li> Under certain circumstances, the Company may be required to disclose Your
                    Personal Data if required to do so by law or in response to valid requests by
                    public authorities (e.g. a court or a government agency).
                </li>
                <li> We may disclose data to Protect against legal liability
                </li>
                <li>We may disclose data to Prevent or investigate possible wrongdoing in connection
                    with the Service
                </li>
            ...
            <p>
                ...
                Address/ e-mail to be listed at time of website deployment
